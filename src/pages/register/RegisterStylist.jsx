    ...
    <section className="min-h-screen bg-gray-100">
      ...
      >
        <div className="flex flex-col space-y-3 mb-6">
          <h3 className="whitespace-nowrap tracking-tight text-2xl font-bold text-center">Registro de Trabajador</h3>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <input
                className="flex h-10 w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                id="idFront"
                type="file"
                accept="image/*"
              />
        ...
        <div className="flex items-center mt-6">
          <button
            className="inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm  transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 bg-blue-600 text-white hover:bg-blue-500 h-10 px-4 py-2 w-full font-bold"
            type="submit"
          >
            Registrarse
          </button>
